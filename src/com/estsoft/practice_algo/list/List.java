...
public interface List<E> {
  ...
  /* 3. We design list structure with focusing on the concept of current position.
  ...
  /* 4. Data structure should make for user a way for manipulating the data in the list.
