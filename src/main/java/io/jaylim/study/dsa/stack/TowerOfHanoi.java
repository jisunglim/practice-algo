...
public class TowerOfHanoi {
	 ...
	 * any rod. The puzzle starts with the disks in a neat io.jaylim.study.dsa.stack in ascending
	 * order of size on one rod, the smallest at the top, thus making a conical 
	 * shape.
	 * 
	 * The objective of the puzzle is to move the entire io.jaylim.study.dsa.stack to another rod,
	 * obeying the following simple rules:
	 * 
	 * 	- (1) Only one disk can be moved at a time.
	 * 	- (2) Each move consists of taking the upper disk from one of the stacks 
	 * 		  and placing it on top of another io.jaylim.study.dsa.stack i.e. a disk can only be
	 * 		  moved if it is the uppermost disk on a io.jaylim.study.dsa.stack.
	 ...
	 * 			
	 * 					p(n) ::= The n disks in a neat io.jaylim.study.dsa.stack in ascending
