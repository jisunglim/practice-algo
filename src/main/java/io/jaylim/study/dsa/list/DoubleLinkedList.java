...
/**
 * The type Double linked io.jaylim.study.dsa.list.
 *
...
public class DoubleLinkedList<E> implements List<E> {
  ...
  /**
   * Instantiates a new Double linked io.jaylim.study.dsa.list.
   */
  ...
  /**
   * Re-initializes Double  linked io.jaylim.study.dsa.list.
   */
  public void clear() {
    this.curr = this.head;
  ...
  /**
   * Moves current position to the beginning of the io.jaylim.study.dsa.list.
   */
  ...
  /**
   * Moves current position to the end of the io.jaylim.study.dsa.list.
   */
  ...
  /**
   * Return the index of the current position on the io.jaylim.study.dsa.list.
  ...
  /**
   * Inserts an item between two element in the io.jaylim.study.dsa.list.
  ...
  /**
   * Appends an item into the io.jaylim.study.dsa.list after the io.jaylim.study.dsa.list end.
  ...
  /**
   * Removes an element from the io.jaylim.study.dsa.list, and return it.
   *
   * @return el The element removed from the io.jaylim.study.dsa.list.
   */
  public E remove() {
  ...
  /**
   * Return the value of the element on the current position in the io.jaylim.study.dsa.list.
   *
  ...
  /**
   * Return the length (or size) of the io.jaylim.study.dsa.list.
   *
   * @return length The length of the io.jaylim.study.dsa.list.
   */
  public int length() {
    return this.count;
  }
