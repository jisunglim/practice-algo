 ...
 *				item in data set.
 *		
 *		[2nd]	Put the n partial trees onto a priority io.jaylim.study.dsa.queue organized
 *				by weight (frequency).
 *		
 *		[loop]	[3rd]	Remove the first two trees (the ones with lowest
 *		|				weight) from the priority io.jaylim.study.dsa.queue.
 *		|
 ...
 *		|
 *		|		[5th]	Put this new tree back into the priority io.jaylim.study.dsa.queue.
 *		|
 *		[REPEAT UNTIL]	Only one Huffman tree is left in the priority io.jaylim.study.dsa.queue.
 *		
